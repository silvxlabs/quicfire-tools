...
class HillPassTopo(TopoType):
    ...
    def __str__(self):
        flag_line = super().__str__()
        params = (f"{self.max_height}\t! m, max height\n"
...
class SlopeMesaTopo(TopoType):
    ...
    def __str__(self):
        flag_line = super().__str__()
        params = (f"{self.slope_axis}\t! N/A, slope axis (0 = x, 1 = y)\n"
...
class CanyonTopo(TopoType):
    ...
    def __str__(self):
        flag_line = super().__str__()
        params = (f"{self.x_start}\t! m, x-start of canyon on slope\n"
...
class HalfCircleTopo(TopoType):
    ...
    def __str__(self):
        flag_line = super().__str__()
        params = (f"{self.x_location}\t! m, x-location\n"
