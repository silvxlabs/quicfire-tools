...
base_pf = '/Users/joliveto/Desktop/Projects/SOPHIE_GUI/CleanGUI/GUI/projects/timetest/' #REPLACE WITH YOUR OWN BASE PROJECT PATH
#CHANGE ME TO YOUR PROJECT FILE!!!!!!
...
#NIKO --- HERE I AM READING IN NC FILE AND THEN PLOTTING!!!!!!!
test = nc.Dataset(fname, 'r')
print(test.variables.keys()) #print out the keys of the nc
density = test.variables['fuels-dens'] # change this word to whatever keys you have in the nc
print(density.shape) #shape should be (time, nz, ny, nx)
plt.imshow(density[2,0,:,:], origin='lower')
plt.show()
test.close()
